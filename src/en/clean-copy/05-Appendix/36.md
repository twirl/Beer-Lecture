...
For every chapter, the closest beer style in the BJCP guidelines is provided, as well as links to the beer-rating websites. If there are several rows in the table, they are sorted by the historical accuracy (descending).
...
| Style | BJCP guidelines | ratebeer | beeradvocate | untappd |
|-------|-----------------|----------|--------------|---------|
| American Porter | 20A. American Porter | Подтип [Porter](https://www.ratebeer/beerstyles/porter/5/) | [Porter — American](https://www.beeradvocate/beer/styles/159/) | [Porter — American](https://untappd/beer/top_rated?type=porter-american) |
